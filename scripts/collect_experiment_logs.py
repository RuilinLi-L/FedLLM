...
def _all_keys(rows: list[dict]) -> list[str]:
    ...
    preferred = [
        ...
        "visible_grad_count",
        "visible_matrix_grad_count",
        "visible_param_names",
        "dager_visible_candidate_count",
        ...
        "rec_token_p75",
        "rec_token_max",
        "rec_maxb_token_count",
        "rec_maxb_token_std",
        "rec_maxb_token_var",
        "rec_maxb_token_min",
        "rec_maxb_token_p25",
        "rec_maxb_token_median",
        "rec_maxb_token_p75",
        "rec_maxb_token_max",
        "agg_rouge1_fm",
        "agg_rouge2_fm",
        "agg_r1fm_r2fm",
        *[
            f"input_{metric}_{part}_{stat}"
            for metric in ("rouge1", "rouge2", "rougeL", "rougeLsum")
            for part in ("fm", "p", "r")
            for stat in ("count", "mean", "std", "var", "min", "p25", "median", "p75", "max")
        ],
        *[
            f"input_r1fm_r2fm_{stat}"
            for stat in ("count", "mean", "std", "var", "min", "p25", "median", "p75", "max")
        ],
        "last_total_time",
        "final_train_loss",
